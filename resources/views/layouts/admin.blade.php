...
@php
    $nav = [
        ...
        ['route' => 'admin.puzzle.index',      'active' => 'admin.puzzle.*',       'icon' => '🔍', 'label' => 'Puzzle Studio'],
        ['route' => 'admin.mind_reader.index', 'active' => 'admin.mind_reader.*',  'icon' => '🔮', 'label' => 'Mind Reader'],
        ['route' => 'admin.this_or_that.index','active' => 'admin.this_or_that.*', 'icon' => '⚖️', 'label' => 'This or That'],
        ['route' => 'admin.name_secret.index', 'active' => 'admin.name_secret.*',  'icon' => '🔤', 'label' => 'Name Secrets'],
