...
class PixabayService
{
    ...
    /**
     * Illustration/vector dhoondo (photos nahi — bachchon ki asli photo se bachne
     * ke liye image_type illustration hi rakhte hain).
     *
    ...
    public function searchIllustrations(string $query, int $perPage = 24): array
    {
        ...
        $res = Http::timeout(30)->get('https://pixabay.com/api/', [
            ...
            'image_type' => 'illustration', // vector renders bhi isme aate hain
            'safesearch' => 'true',
